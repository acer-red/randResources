...
var humorousNouns = []string{
	"猪", "香蕉", "幽灵", "企鹅", "袜子", "拖鞋", "键盘", "鼠标", "猫", "狗", "熊猫", "熊", "猩猩", "猴子", "狮子", "老虎",
	"吃货", "程序猿", "铲屎官", "键盘侠", "网红", "非酋", "杠精", "干饭人", "打工人",
	"柠檬精", "熬夜冠军", "秃头怪", "肥宅", "瘦猴", "咕咕机", "键盘喷子", "吃瓜群众", "气氛组", "显眼包",
	"小透明", "冤种", "大冤种", "社畜",
}
...
var humorousAdverbs = []string{
	...
	"兴高采烈地", "垂头丧气地", "若无其事地", "装模作样地", "煞有介事地", "鬼鬼祟祟地", "慢悠悠地", "狠狠地", "优雅地", "激情澎湃地", "敷衍地", "懒散地", "疲惫地",
}

var humorousVerbs = []string{
	"跳舞", "唱歌", "思考", "睡觉", "奔跑", "飞翔", "爬行", "尖叫", "耳语", "放屁",
	"喜欢", "讨厌", "寻找", "梦想着", "假装", "摸鱼", "躺平", "内卷", "吐槽",
